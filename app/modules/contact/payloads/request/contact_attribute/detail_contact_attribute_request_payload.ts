...
export default class DetailContactAttributeRequestPayload extends DataPayload('modules/contact/payloads/request/contact_attribute/detail_contact_attribute_request_payload')({
